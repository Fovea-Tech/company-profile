...
export default function JsonLd() {
  ...
  const organizationSchema = {
    ...
    description:
      'Fovea Teknologi adalah perusahaan perangkat lunak (software house) spesialis dalam solusi digitalisasi sekolah swasta (website & PPDB online) dan kemitraan teknis (white-label website development) bagi agensi digital.',
    foundingDate: '2026',
    priceRange: '$$',
    areaServed: [
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        {
          '@type': 'Offer',
          url: `${BASE}/solusi-pendidikan`,
          itemOffered: {
            '@type': 'Service',
            name: 'Solusi Digitalisasi Pendidikan',
            description:
              'Pembuatan website sekolah premium, sistem PPDB online yang skalabel, dan portal administrasi guru/siswa untuk efisiensi operasional pendidikan swasta.',
            url: `${BASE}/solusi-pendidikan`,
          },
        },
        {
          '@type': 'Offer',
          url: `${BASE}/agency-partnership`,
          itemOffered: {
            '@type': 'Service',
            name: 'Kemitraan Technical Agency',
            description:
              'Layanan pembuatan website white-label, landing page, dan sistem custom sebagai partner teknis andalan bagi agensi digital dan kreatif.',
            url: `${BASE}/agency-partnership`,
          },
        },
        {
  ...
  const websiteSchema = {
    ...
    description:
      'Spesialis Solusi Digitalisasi Pendidikan (Website & PPDB Online) serta Kemitraan Agensi Digital (White-label Web Development).',
    publisher: {
      '@id': `${BASE}/#organization`,
    },
    inLanguage: ['id-ID'],
  ...
  const webPageSchema = {
    ...
    '@id': `${BASE}/#webpage`,
    url: BASE,
    name: 'Fovea Teknologi | Digitalisasi Sekolah & Partner Web Agensi',
    description:
      'Software house spesialis digitalisasi pendidikan (website sekolah premium, PPDB online) dan partner web white-label bagi agensi digital.',
  ...
  const serviceListSchema = {
    ...
    description: 'Daftar layanan utama yang tersedia di Fovea Teknologi',
    numberOfItems: 3,
    itemListElement: [
      {
        '@type': 'ListItem',
