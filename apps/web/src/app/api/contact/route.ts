...
export async function POST(request: Request) {
  try {
    ...
    // Sanitize inputs to prevent HTML/XSS injection in the email body
    ...
    await transporter.sendMail({
      ...
      replyTo: email,
      subject: `[Fovea] Pesan baru dari ${safeName}`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; background: #0f1117; color: #e2e8f0; padding: 32px; border-radius: 16px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #1e293b; color: #f1f5f9; font-size: 14px;">${safeName}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 12px 0; border-bottom: 1px solid #1e293b; color: #f1f5f9; font-size: 14px;">${serviceLabel[service] ?? safeService}</td>
            </tr>
          </table>

          <div style="margin-top: 24px;">
            <p style="color: #94a3b8; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px;">Pesan</p>
            <div style="background: #1e293b; border-radius: 12px; padding: 16px; font-size: 14px; color: #f1f5f9; line-height: 1.7; white-space: pre-wrap;">${safeMessage}</div>
          </div>
          ...
          <p style="margin-top: 32px; font-size: 12px; color: #475569; border-top: 1px solid #1e293b; padding-top: 16px;">
            ...
            Balas email ini untuk langsung membalas ke ${safeName}.
          </p>
        </div>
      `,
    });
