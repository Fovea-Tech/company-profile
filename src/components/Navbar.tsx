        ...
        >
          <Link href="/#hero" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center">
              <Image src="/logo_dark.svg" alt={t.nav.brand} width={28} height={28} priority style={{ width: 'auto', height: 'auto' }} />
            </div>
            <div>
              <p className="text-sm font-semibold tracking-[0.14em] text-fg uppercase">{t.nav.brand}</p>
            </div>
          </Link>
