...
"[project]/src/i18n/messages/en.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const en = {
    ...
    hero: {
        ...
        subtitle: 'We craft innovative SaaS products and high-quality custom websites that drive your business forward.',
        cta: 'Our Services',
    ...
    services: {
        ...
        saasDesc: 'We build scalable, secure subscription-based software products ready to meet the demands of your modern business.',
        webTitle: 'Custom Website Development',
        webDesc: 'Tailored websites with modern design, high performance, and maximum SEO optimization.'
    },
    portfolio: {
        heading: 'Portfolio',
    ...
    portfolioDetail: {
        ...
        categoryLabel: {
            saas: 'SaaS Product',
            upcoming: 'Upcoming SaaS',
            custom: 'Custom Project'
        }
    },
    about: {
        heading: 'About Fovea Technology',
        subheading: 'We are a software house focused on building innovative SaaS products and delivering high-quality custom web services. Technology is our tool for creating a better future.',
        valuesHeading: 'Our Values',
        teamHeading: 'Our Team',
        values: [
            {
                title: 'Innovation',
                desc: 'Always seeking new solutions and the latest technologies.'
            },
            {
                title: 'Quality',
                desc: 'The highest standards in every aspect of development.'
            },
            {
                title: 'Collaboration',
                desc: 'Working closely with clients to realize their vision.'
            },
            {
                title: 'Sustainability',
                desc: 'Solutions that are relevant today and in the future.'
            }
        ]
    },
    contact: {
...
//# sourceMappingURL=src_i18n_messages_en_ts_0gqhkzs._.js.map